...
export default function Dashboard() {
  ...
  return (
    <div className="bg-[#f5f5f5] pb-16 min-h-screen">
      <main className="px-0 pt-0 pb-8 max-w-4xl mx-auto">
        ...
        <section className="bg-white border border-[#d5d8dc] rounded-none shadow-none mb-3">
          <div className="bg-[#f5f5f5] px-3 py-2 border-b border-[#d5d8dc] flex items-center gap-2">
          ...
          <div className="p-4 pb-8 flex gap-2">
            <input
              ...
              className="flex-1 border border-[#ced4da] rounded px-3 py-1.5 text-sm placeholder-gray-400 focus:outline-none focus:border-[#12b886] text-[#333] bg-white"
            />
            <button
              onClick={handleSearch}
              className="bg-[#12b886] text-white px-4 py-1.5 rounded text-sm font-medium flex items-center gap-1.5 hover:bg-[#0ca678] transition-colors"
            >
        ...
        <section className="bg-white border border-[#d5d8dc] rounded-none shadow-none">
          <div className="bg-[#f5f5f5] px-3 py-2 border-b border-[#d5d8dc] flex items-center gap-3">
            <span className="font-bold text-[#333] text-sm">Sport Highlights</span>
            <button
              onClick={handleRefresh}
              className="bg-[#12b886] text-white text-xs px-3 py-0.5 rounded hover:bg-[#0ca678] transition-colors"
            >
              Refresh
            </button>
          </div>
              ...
              <table className="w-full text-sm border-collapse">
                <tbody>
                  {Object.entries(groupedMatches).map(([sport, sportMatches]) => (
                    <Fragment key={sport}>
                      <tr>
                        <td className="border border-[#d5d8dc] px-3 py-2 font-bold text-[#333] bg-white text-sm">{sport}</td>
                        <td className="border border-[#d5d8dc] px-3 py-2 font-bold text-[#333] bg-white w-32 text-sm">Amount</td>
                      </tr>
                        ...
                        return (
                          <tr key={match.id} className={idx % 2 === 0 ? 'bg-white' : 'bg-[#f9f9f9]'}>
                            <td className="border border-[#d5d8dc] px-3 py-2">
                              <span className="text-[#12b886] text-sm font-normal cursor-pointer hover:underline">
                                {match.title} / Match Odds
                              </span>
                              {match.status === 'live' && (
                                <>
                                  <br />
                                  <span className="inline-block w-2.5 h-2.5 rounded-full bg-[#12b886] mt-1" />
                                </>
                              )}
                            </td>
                            <td className="border border-[#d5d8dc] px-3 py-2 text-[#333] text-sm font-medium">
                              {formatAmount(amount)}
                            </td>
                          </tr>
                        );
