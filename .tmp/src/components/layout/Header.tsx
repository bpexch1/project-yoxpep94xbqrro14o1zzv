...
export function Header() {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 bg-[#254465] flex items-center justify-between px-4 h-12 border-b border-[#1a3550] shadow-sm">
        {/* LEFT: Hamburger */}
        <div className="flex items-center gap-2">
          <button 
            onClick={() => setIsSidebarOpen(true)}
            className="p-1 hover:bg-[#3d6b8b] rounded transition-colors"
          >
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 text-sm whitespace-nowrap border-l border-[#3d6b8b] pl-3">
            <span className="text-white font-bold"><span className="text-[#a8c8e8]">B:</span> 0</span>
            <span className="text-white font-bold"><span className="text-[#a8c8e8]">Exp:</span> 0</span>
          </div>
        </div>
      </header>
