...
import { Pencil, User, Book, Loader2 } from "lucide-react";
            ...
            <tbody>
              <tr>
                <td className="py-1.5 px-2 border border-[#ccc] text-center whitespace-nowrap">
                  <span className={cn("text-[13px] font-bold", balanceVisible && totals.credit_received > 0 ? "text-[#28a745]" : "text-[#212529]")}>
                    {balanceVisible ? totals.credit_received.toLocaleString() : "0"}
                  </span>
                </td>
                <td className="py-1.5 px-2 border border-[#ccc] text-center whitespace-nowrap">
                  <span className={cn("text-[13px] font-bold", balanceVisible && totals.credit_remaining > 0 ? "text-[#28a745]" : "text-[#212529]")}>
                ...
                <td className="py-1.5 px-2 border border-[#ccc] text-center whitespace-nowrap">
                  <span className={cn("text-[13px] font-bold", balanceVisible && totals.balance_upline < 0 ? "text-[#dc3545]" : balanceVisible && totals.balance_upline > 0 ? "text-[#28a745]" : "text-[#212529]")}>
        ...
        <table className="w-full text-left text-[12px] border-collapse">
          <thead>
            ...
            <tr className="bg-[#ecf0f1] border-y border-[#d5d8dc]">
              ...
              <th className="px-4 py-2.5 font-bold text-[#212529] text-right border-r border-[#d5d8dc]">Credit</th>
              <th className="px-4 py-2.5 font-bold text-[#212529] text-right">Balance</th>
            </tr>
          </thead>
          <tbody>
            {isLoading ? (
              ...
              <tr>
                <td colSpan={4} className="px-3 py-8 text-center text-[#212529] bg-white font-medium">
                  No data available
                </td>
              </tr>
            ) : (
                ...
                return (
                  <React.Fragment key={client.id}>
                    ...
                    <tr className={cn(idx % 2 === 0 ? "bg-white" : "bg-[#f4f6f7]", "border-b border-[#d5d8dc]")}>
                      ...
                      <td className={cn("px-3 lg:px-4 py-3 border-r border-[#d5d8dc] text-right font-semibold", balanceVisible ? "text-[#212529]" : "text-[#212529]")}>
                        {balanceVisible ? (client.credit_received || 0).toLocaleString() : "0"}
                      </td>
                      <td className={cn(
                        ...
                        {balanceVisible ? (client.balance_upline || 0).toLocaleString() : "0"}
                      </td>
                    </tr>

                    {/* Expanded details row — only when row is expanded */}
                    {isExpanded && (
                      <tr>
                        <td colSpan={4} className={cn("px-5 py-4 border-b border-[#d5d8dc]", idx % 2 === 0 ? "bg-slate-50" : "bg-white")}>
                            ...
                            <ul className="text-[13px] text-[#212529] space-y-2 relative z-10">
                              <li className="flex items-center gap-2">
                                ...
                                <span className={cn("font-bold", balanceVisible && (client.pl_downline || 0) < 0 ? "text-[#dc3545]" : balanceVisible ? "text-[#28a745]" : "text-[#212529]")}>
                                  {balanceVisible ? (client.pl_downline || 0).toLocaleString() : "0"}
                                </span>
                              </li>
                              <li className="flex items-center gap-2">
                                <span className="text-[#28a745] font-bold">•</span>
                              ...
                              <li className="flex items-center gap-2">
                                ...
                                <span className={cn("font-bold", balanceVisible ? "text-[#28a745]" : "text-[#212529]")}>
                                  {balanceVisible ? (client.credit_remaining || 0).toLocaleString() : "0"}
                                </span>
                              </li>
