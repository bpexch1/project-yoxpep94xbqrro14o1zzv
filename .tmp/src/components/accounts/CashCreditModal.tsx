                ...
                <tbody className="border-t border-[#d5d8dc]">
                  <tr className="bg-white">
                    {activeTab === 'cash' ? (
                      <>
                        <td 
                          className="px-3 py-2 font-bold border-r border-[#d5d8dc] text-[#16a085] underline cursor-pointer hover:opacity-75 transition-opacity"
                        ...
                        <td 
                          className="px-3 py-2 font-bold text-[#16a085] underline cursor-pointer hover:opacity-75 transition-opacity"
                          onClick={() => setShowHistory(true)}
                          title="Click to view transaction history"
                        >
