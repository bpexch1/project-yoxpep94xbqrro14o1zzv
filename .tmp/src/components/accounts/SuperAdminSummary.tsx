...
export function SuperAdminSummary({ clients, isLoading, username }: SuperAdminSummaryProps) {
  const stats = {
  ...
  return (
    <section className="bg-white rounded border border-gray-200 shadow-sm overflow-hidden mb-3">
      <div className="px-3 py-2 border-b border-gray-200 bg-slate-50 flex items-center gap-2">
        <span className="text-[11px] font-bold text-slate-700 tracking-tight">{username} - Overview</span>
      </div>
