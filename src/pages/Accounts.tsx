...
export default function Accounts() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#e8e8e8", fontFamily: "Roboto, system-ui, sans-serif" }}>
      <main style={{ width: "100%", padding: "8px 15px 12px" }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontWeight: 700, fontSize: "14px", color: "#000000", fontFamily: "Roboto, system-ui, sans-serif" }}>Search-Users</span>
          </div>
