...
export default function Dashboard() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#ecf0f1", fontFamily: "Roboto, system-ui, sans-serif" }}>
      <main style={{ width: "100%", padding: "12px 12px 80px" }}>

        {/* 1. Search-Users Card */}
        <div style={{ background: "#fff", borderRadius: 8, border: "1px solid #d0d0d0", marginBottom: 14, overflow: "hidden" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "9px 14px", background: "#ecf0f1", borderBottom: "1px solid #d0d0d0" }}>
        ...
        <div style={{ background: "#fff", borderRadius: 8, border: "1px solid #d0d0d0", marginBottom: 14, overflow: "hidden" }}>
          {/* Header */}
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "9px 14px", background: "#ecf0f1", borderBottom: "1px solid #d0d0d0" }}>
            <span style={{ fontWeight: 700, fontSize: 14, color: "#212529" }}>Sport Highlights</span>
            <button
