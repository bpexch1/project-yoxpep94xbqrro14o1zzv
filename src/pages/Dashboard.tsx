              ...
              <table className="w-full text-sm border-collapse">
                <tbody>
                  {Object.entries(groupedMatches).map(([sport, sportMatches]) => (
                    <Fragment key={sport}>
                      <tr>
                        <td className="border border-[#d5d8dc] px-3 py-2 font-bold text-[#2c3e50] bg-white text-sm">{sport}</td>
                        <td className="border border-[#d5d8dc] px-3 py-2 font-bold text-[#2c3e50] bg-white w-32 text-sm">Amount</td>
                      </tr>
