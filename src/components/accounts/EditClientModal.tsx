        ...
        <form onSubmit={handleSubmit}>
          <div className="bg-white px-6 py-5 space-y-4 max-h-[65vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                <Label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Credit Limit</Label>
                <Input
            ...
            <div className="border-t border-dashed border-slate-200 pt-4">
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-3">Change Password (optional)</p>
              <div className="space-y-3">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-9 pr-10 h-11 text-sm bg-slate-50 border-slate-200"
                  />
                  <button
                    type="button"
