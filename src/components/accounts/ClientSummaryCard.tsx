  ...
  return (
    <section className="bg-white rounded shadow-sm overflow-hidden border">
      <div className="bg-slate-50 px-4 py-2 border-b text-sm font-bold text-slate-800">
        NomanSA8592 - Clients List | Default
      </div>
      ...
      <div className="mt-4">
        <button className="w-full bg-amber-400 hover:bg-amber-500 text-black font-bold py-3 text-sm transition-colors uppercase tracking-wider">
          Load Balance
        </button>
